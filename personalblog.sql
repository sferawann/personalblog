...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Mar 2021 pada 01.38
...
INSERT INTO `home` (`id_home`, `id_settings`, `caption_1_home`, `caption_2_home`, `heading_hoome`) VALUES
(1, 1, 'Hallo', 'Apa Kabar', 'Welcome to Personal Blog'),
(2, 2, 'Kabar Baik', 'Alhamdulilah', 'Welcome to Personal Blog2');
...
CREATE TABLE `research` (
  ...
  `abstract_research` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
