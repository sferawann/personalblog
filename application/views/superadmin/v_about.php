...
<body class="page-header-fixed compact-menu pace-done page-sidebar-fixed">
                                    ...
                                    <table id="data-table" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?php echo $no; ?></td>
                                                    <td><img src="<?php echo base_url() . 'assets/img/' . $row->image_aboutme; ?>" width="100" class="thumbnail"></td>
                                                    <td><?php echo $row->fullname_aboutme; ?></td>
                                                    <td><?php echo $row->email_aboutme; ?></td>
                                                    <td><?php echo $row->location_aboutme; ?></td>
    ...
    <!--DELETE RECORD MODAL-->
    <form action="<?php echo site_url('superadmin/About/delete'); ?>" method="post">
        <div class="modal fade" id="DeleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Delete About</h4>
                    </div>
                    <div class="modal-body">
                        <div class="alert alert-info">
                            Anda yakin mau menghapus About ini?
                        </div>
                    </div>
