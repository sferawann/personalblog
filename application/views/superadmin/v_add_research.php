...
<body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
    ...
    <main class="page-content content-wrap">
        ...
        <div class="page-inner">
            ...
            <div id="main-wrapper">
                <div class="row">
                    <form method="post" action="<?php echo site_url('superadmin/research/publish') ?>">
                        <div class="col-md-8">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label>Author</label>
                                        <input type="text" name="author_research" class="form-control title" placeholder="Author" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Title</label>
                                        <input type="text" name="tittle_research" class="form-control title" placeholder="Title" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Jurnal Name</label>
                                        <input type="text" name="jurnalname_research" class="form-control title" placeholder="Jurnal Name" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Publisher</label>
                                        <input type="text" name="publisher_research" class="form-control title" placeholder="Publisher" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Volume</label>
                                        <input type="text" name="volume_research" class="form-control title" placeholder="Volume" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Tanggal</label>
                                        <input type="text" name="date_research" class="form-control title" placeholder="Volume" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Page</label>
                                        <input type="text" name="pages_research" class="form-control title" placeholder="Page" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Link</label>
                                        <input type="text" name="link_research" class="form-control slug" placeholder="Permalink" style="background-color: #F8F8F8;outline-color: none;border:0;color:blue;" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label">Abstract</label>
                                        <textarea name="abstract_research" id="summernote"></textarea>
                                    </div>
