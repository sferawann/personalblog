...
<body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
    ...
    <main class="page-content content-wrap">
        ...
        <div class="page-inner">
            ...
            <div id="main-wrapper">
                <div class="row">
                    <form action="<?php echo base_url() . 'superadmin/Experience/edit' ?>" method="post" enctype="multipart/form-data">
                        <div class="col-md-8">
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    <input type="hidden" name="id_about" value="<?= $b['id_about'] ?>" class="form-control title">
                                    <div class="form-group">
                                        <label>Nama Experience</label>
                                        <input type="text" name="name_about" value="<?= $b['name_about'] ?>" class="form-control title" placeholder="Nama Experience" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Tahun Experience</label>
                                        <input type="text" name="tahun_about" value="<?= $b['tahun_about'] ?>" class="form-control title" placeholder="Tahun Experience" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Description Experience</label>
                                        <input type="text" name="description_about" value="<?= $b['description_about'] ?>" class="form-control title" placeholder="Description Experience" required>
                                    </div>
