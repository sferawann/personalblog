...
<body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
    ...
    <main class="page-content content-wrap">
                                            ...
                                            ?>
                                                <li>
                                                    <a href="<?php echo site_url('superadmin/inbox'); ?>">
                                                        <div class="msg-img">
                                                            <div class="online on"></div><img class="img-circle" src="<?php echo base_url() . 'assets/imb/user_blank.png'; ?>" alt="">
                                                        </div>
        ...
        <div class="page-inner">
            ...
            <div id="main-wrapper">
                <div class="row">
                    <form action="<?php echo base_url() . 'superadmin/post/publish' ?>" method="post" enctype="multipart/form-data">
                        <div class="col-md-8">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div style="overflow-y:scroll;height:150px;margin-bottom:30px;">
                                        <?php foreach ($tag->result() as $row) : ?>
                                            <div class="form-group">
                                                <label>
                                                    <input type="checkbox" name="tag[]" value="<?php echo $row->name_tags; ?>"> <?php echo $row->name_tags; ?>
                                                </label>
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
