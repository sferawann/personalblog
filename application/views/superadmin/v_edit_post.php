...
<body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
    ...
    <main class="page-content content-wrap">
        ...
        <div class="page-inner">
            ...
            <div id="main-wrapper">
                <div class="row">
                    <form action="<?php echo base_url() . 'superadmin/post/edit' ?>" method="post" enctype="multipart/form-data">
                        <div class="col-md-8">
                            <div class="panel panel-white">

                                <div class="panel-body">
                                    <!-- <input type="hidden" name="id" value="<?= $b['id_post'] ?>" class="form-control title"> -->

                                    <div class="form-group">
                                        <label>Title</label>
                                        <input type="text" name="title" value="<?php echo $b['tittle_post']; ?>" class="form-control" placeholder="Title" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="slug" class="form-control" value="<?php echo $b['slug_post']; ?>" placeholder="Permalink" style="background-color: #F8F8F8;outline-color: none;border:0;color:blue;" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label">Contents</label>
                                        <textarea name="contents" id="summernote" value="<?php echo $b['contens_post']; ?>"><?php echo $b['contens_post']; ?></textarea>
                                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label>Image</label>
                                        <input type="file" name="filefoto" class="dropify" data-height="190" data-default-file="<?php echo base_url() . 'assets/img/' . $b['image_post']; ?>">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="category" required>
                                            ...
                                            <?php foreach ($category->result() as $row) : ?>
                                                <?php if ($b['categoryid_post'] == $row->id_category) : ?>
                                    ...
                                    <div style="overflow-y:scroll;height:150px;margin-bottom:30px;">
                                        <?php
                                        $tag_post = $b['tags_post'];
                                        $strtag = explode(",", $tag_post);
                                        for ($j = 0; $j < count($strtag); $j++) {
                                        }
                                        foreach ($tag->result() as $row) : ?>
                                            <div class="form-group">
                                                <label>
                                                    <input type="checkbox" name="tag[]" value="<?php echo $row->name_tags; ?>" <?php if (in_array($row->name_tags, $strtag)) echo 'checked="checked"'; ?>> <?php echo $row->name_tags; ?>
                                                </label>
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
                                    <div class="form-group">
                                        <input type="hidden" name="id_post" value="<?php echo $b['id_post']; ?>" required>
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" cols="6" rows="6" class="form-control" placeholder="Meta Description"><?php echo $b['description_post']; ?></textarea>
                                    </div>
