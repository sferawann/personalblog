...
<body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
    ...
    <main class="page-content content-wrap">
        ...
        <div class="page-inner">
            ...
            <div id="main-wrapper">
                <div class="row">
                    <form action="<?php echo base_url() . 'superadmin/pkm/publish' ?>" method="post" enctype="multipart/form-data">
                        <div class="col-md-8">
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label>Nama Kegiatan</label>
                                        <input type="text" name="namakegiatan_pkm" class="form-control title" placeholder="Author" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Ketua/Jurusan</label>
                                        <input type="text" name="ketuanjurusan_pkm" class="form-control title" placeholder="Title" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Anggota Jurusan</label>
                                        <input type="text" name="anggotajurusan_pkm" class="form-control title" placeholder="Jurnal Name" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Mitra</label>
                                        <input type="text" name="mitra_pkm" class="form-control title" placeholder="Publisher" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Lingkup</label>
                                        <input type="text" name="lingkup_pkm" class="form-control title" placeholder="Volume" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Mulai</label>
                                        <input type="text" name="mulai_pkm" class="form-control title" placeholder="Volume" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Selesai</label>
                                        <input type="text" name="selesai_pkm" class="form-control title" placeholder="Page" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Sumber Dana</label>
                                        <input type="text" name="sumberdana_pkm" class="form-control title" placeholder="Page" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Jumlah Dana</label>
                                        <input type="text" name="jumlahdana_pkm" class="form-control title" placeholder="Page" required>
                                    </div>
