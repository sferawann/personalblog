...
<body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
    ...
    <main class="page-content content-wrap">
        ...
        <div class="page-inner">
            <div class="page-title">
                ...
                <div class="page-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo site_url('superadmin/experience'); ?>">Experience</a></li>
            ...
            <div id="main-wrapper">
                <div class="row">
                    <form action="<?php echo base_url() . 'superadmin/Experience/publish' ?>" method="post" enctype="multipart/form-data">
                        <div class="col-md-8">
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label>Nama Experience</label>
                                        <input type="text" name="name_about" class="form-control title" placeholder="Nama Experience" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Tahun Experience</label>
                                        <input type="text" name="tahun_about" class="form-control title" placeholder="Tahun Experience" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Description Experience</label>
                                        <input type="text" name="description_about" class="form-control title" placeholder="Description Experience" required>
                                    </div>
