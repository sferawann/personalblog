...
<body class="page-header-fixed compact-menu pace-done page-sidebar-fixed">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-white">
                            <div class="panel-body">
                                <a href="<?php echo site_url('superadmin/research/add_new'); ?>" style="background-color: #697194" class="btn btn-success m-b-sm">Add New Research</a>
                                    ...
                                    <table id="data-table" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?php echo $no; ?></td>
                                                    <td><?php echo $row->tittle_research; ?></td>
                                                    <td><?php echo $row->date_research; ?></td>
                                                    <td style="text-align: center;">
                                                        <a href="<?php echo site_url('superadmin/research/get_edit/' . $row->id_research); ?>" class="btn btn-xs"><span class="fa fa-pencil"></span></a>
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-delete" data-id="<?php echo $row->id_research; ?>"><span class="fa fa-trash"></span></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
    ...
    <form action="<?php echo site_url('superadmin/Research/delete'); ?>" method="post">
