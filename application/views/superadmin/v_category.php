        ...
        <div class="page-sidebar sidebar">
            <div class="page-sidebar-inner slimscroll">
                ...
                <ul class="menu accordion-menu" style="background: linear-gradient(to right,#e8b38c, #697194)">
                    ...
                    <li class="droplink active open" style="color: white;"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-pin"></span>
                        ...
                        <ul class="sub-menu" style="background: linear-gradient(to right,#e8b38c, #697194)">
                            ...
                            <li class="active"><a href="<?php echo site_url('backend/category'); ?>" style="color: white;">Category</a></li>
