...
<body class="page-header-fixed compact-menu pace-done page-sidebar-fixed">
            ...
            <div class="page-title">
                ...
                <div class="page-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo site_url('superadmin/post'); ?>">Course</a></li>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-white">
                            <div class="panel-body">
                                <button type="button" style="background-color: #697194" class="btn btn-success m-b-sm" data-toggle="modal" data-target="#myModal">Add New Category</button>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-edit" data-id="<?php echo $row->id_category; ?>" data-category="<?php echo $row->name_category; ?>"><span class="fa fa-pencil"></span></a>
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-delete" data-id="<?php echo $row->id_category; ?>"><span class="fa fa-trash"></span></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
    ...
    <!--ADD RECORD MODAL-->
    <form action="<?php echo site_url('superadmin/category/save'); ?>" method="post">
    ...
    <!--EDIT RECORD MODAL-->
    <form action="<?php echo site_url('superadmin/category/edit'); ?>" method="post">
    ...
    <!--DELETE RECORD MODAL-->
    <form action="<?php echo site_url('superadmin/category/delete'); ?>" method="post">
