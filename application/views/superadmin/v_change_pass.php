        ...
        <div class="page-sidebar sidebar">
            <div class="page-sidebar-inner slimscroll">
                ...
                <ul class="menu accordion-menu" style="background: linear-gradient(to right,#e8b38c, #697194)">
                    ...
                    <li class="droplink"><a href="#" class="waves-effect waves-button" style="color: white;"><span class="menu-icon icon-pin"></span>
                    ...
                    <li><a href="<?php echo site_url('backend/testimonial'); ?>" style="color: white;" class="waves-effect waves-button"><span class="menu-icon icon-like"></span>
                            <p>Testimonials</p>
                        </a></li>
                                ...
                                <form class="form-horizontal" action="<?php echo site_url('backend/change_pass/change'); ?>" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <button type="submit" style="background-color: #697194" class="btn btn-success">Change Password</button>
                                        </div>
                                    </div>
