...
<body class="page-header-fixed compact-menu pace-done page-sidebar-fixed">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-white">
                            <div class="panel-body">
                                <a href="<?php echo site_url('superadmin/Experience/add_new'); ?>" style="background-color: #697194" class="btn btn-success m-b-sm">Add New Experience</a>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row->tahun_about; ?></td>
                                                    <td><?php echo $row->description_about; ?></td>
                                                    <td style="text-align: center;">
                                                        <a href="<?php echo site_url('superadmin/Experience/get_edit/' . $row->id_about); ?>" class="btn btn-xs"><span class="fa fa-pencil"></span></a>
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-delete" data-id="<?php echo $row->id_about; ?>"><span class="fa fa-trash"></span></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
    ...
    <!--DELETE RECORD MODAL-->
    <form action="<?php echo site_url('superadmin/Experiences/delete'); ?>" method="post">
